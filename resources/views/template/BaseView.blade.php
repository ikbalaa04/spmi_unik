...
<head>
    ...
    <title>{{ $siteSettings['system_name'] ?: $siteSettings['campus_name'] }} - {{ $title ?? 'Dashboard' }}</title>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>&copy; Copyright
                            <strong><span>{{ $siteSettings['system_name'] ?: $siteSettings['campus_name'] }}</span></strong>.
