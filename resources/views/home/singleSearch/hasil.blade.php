                ...
                <div class="public-table-card">
                    <div class="public-table-card-header">
                        <div>
                            ...
                            <p>Dokumen yang cocok dengan program studi dan kriteria pencarian.</p>
                        </div>
                            ...
                            <tbody>
                                @forelse ($berkas as $i)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="public-prodi-badge">
                                                {{ optional($i->prodi)->kode ?? '-' }}
                                                <small>{{ optional($i->prodi)->name ?? 'Program studi tidak tersedia' }}</small>
                                            </span>
                                        </td>
                                    </tr>
                                @empty
